...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -MMD -MP -Wall -Os -ffunction-sections -fdata-sections -fomit-frame-pointer -fno-strict-aliasing -fno-asynchronous-unwind-tables -fno-unwind-tables ${ARCH}")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "${ARCH} -ftls-model=local-exec -L${LIBNX}/lib -L${PORTLIBS}/lib -Wl,--gc-sections -Wl,--as-needed -Wl,-wrap,__cxa_throw -Wl,-wrap,_Unwind_Resume -Wl,-wrap,__gxx_personality_v0")
